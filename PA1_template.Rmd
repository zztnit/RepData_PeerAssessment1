...
```{r histogram1, fig.width= 6, fig.height= 4, fig.align='center'}
...
Identifier **`r intervalMaxSteps`** of 5-minute interval(i.e. time **8:35-8:40**), on average across all the days in the dataset, contains the maximum number of steps.  And the corresponding maximum number of steps is **`r formatC(maxsteps, format ="f", digits =3)`**.


## Imputing missing values
```{r histogram2, fig.width= 6, fig.height= 4, fig.align='center'}
...
:----:|:-----------------------:|:-------------------------:|:-------------:
The mean total number of steps taken per day |`r formatC(mean_steps, format ="f", digits =3)` |`r formatC(mean_steps2, format ="f", digits =3)` |`r formatC(diff_mean_steps, format ="f", digits =3)`
The median total number of steps taken per day |`r median_steps` |`r formatC(median_steps2, format ="f", digits =3)` |`r diff_median_steps`
